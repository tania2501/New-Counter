...
type ActionType = OnClickPlus | OnClickReset | OnChangeMaxValue | OnChangeStartValue | AddValue | SetError
type SetError = {
  type: 'SET_ERROR'
  error: boolean
}
...
export const setErrorAC = (error: boolean) => {return {type: 'SET_ERROR', error}}
